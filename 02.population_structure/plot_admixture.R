...
indTable=read.table("sampleinfo125.txt.ordered.mafalda", header=T)
colnames(indTable)=c("id1","id2","sampling_location","name_region","longitude","latitude","collection_season","species","order_in_vcf","order_in_admixture")
