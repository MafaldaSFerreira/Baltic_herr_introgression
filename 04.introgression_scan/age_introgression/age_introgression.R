...
# 00.revisions_relabeling/00.population_labels.R for the convention). The
# chrN_age_est_UPPMAX.RData files loaded below live in this Figshare folder.
setwd("../Figshare/4.introgression_scan/age_introgression")
...
#pdf(file = "<path_to_local_output_dir>/GW_age_hist_UPPMAX.pdf")  # not part of the Figshare deposit
age_co <- 1e5
atl_col <- col2rgb("red")
...
plot_top_regions_2(top_pos = old_windows, win_df = h79_20k_w, geno = herring_79$geno, sample_list = herring_79$sample_list, plot_dir = "<path_to_local_output_dir>/", snp_col = "blue")  # not part of the Figshare deposit
