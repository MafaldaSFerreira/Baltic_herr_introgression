...
ggsave(all_plots, filename=paste0("thrb_panel_2025-08-09_zoomin_AtlanticSpring.pdf")  # saved to your R working directory; set to wherever you want to save it, height = 110, width = 100, units = "mm")
ggsave(all_plots, filename=paste0("thrb_panel_2026-03-02_zoomin_AtlanticSpring.pdf")  # saved to your R working directory; set to wherever you want to save it, height = 110, width = 100, units = "mm")
ggsave(all_plots, filename=paste0("thrb_panel_2026-05-20_zoomin_AtlanticSpring.pdf")  # saved to your R working directory; set to wherever you want to save it, height = 110, width = 100, units = "mm")
ggsave(all_plots, filename=paste0("thrb_panel_2026-05-20_zoomin_AtlanticSpring_legend.pdf")  # saved to your R working directory; set to wherever you want to save it, height = 110, width = 100, units = "mm")
...
ggsave(plot_pops_freq_df, filename=paste0("thrb_AF_heatmap_2025-08-09.pdf")  # saved to your R working directory; set to wherever you want to save it, height = 50, width = 100, units = "mm")
